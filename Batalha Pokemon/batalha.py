...
while True:
    ...
    if escolha == 1:
        ...
        while True:
            ...
            sleep(0.7)
            print(f'O Rayquaza agora está com \033[1;31m{vida_inimigo(vida_rayquaza, values_char[ataque])}\033[m de vida')
            vida_rayquaza = vida_inimigo(vida_rayquaza, values_char[ataque])
            if vida_rayquaza == 0:
                linha()
            ...
            while limites_ray[jogada_rayquaza] == 0:
                jogada_rayquaza = randint(0, 3)
            sleep(0.7)
            print(f'Agora o Charizard está com \033[1;31m{vida_aliado(vida_charizard, values_ray[jogada_rayquaza])}\033[m de vida')
            vida_charizard = vida_aliado(vida_charizard, values_ray[jogada_rayquaza])
            if vida_charizard == 0:
                linha()
    ...
    if escolha == 2:
        ...
        while True:
            ...
            sleep(0.7)
            print(f'O Rayquaza agora está com \033[1;31m{vida_inimigo(vida_rayquaza, values_blas[ataque])}\033[m de vida')
            vida_rayquaza = vida_inimigo(vida_rayquaza, values_blas[ataque])
            if vida_rayquaza == 0:
                linha()
                print(f'\033[1;92mPARABÉNS! VOCÊ VENCEU\033[m')
                break
            ...
            while limites_ray[jogada_rayquaza] == 0:
                jogada_rayquaza = randint(0, 3)
            sleep(0.7)
            print(f'Agora o Blastoise está com \033[1;31m{vida_aliado(vida_blastoise, values_ray[jogada_rayquaza])}\033[m de vida')
            vida_blastoise = vida_aliado(vida_blastoise, values_ray[jogada_rayquaza])
            if vida_blastoise == 0:
                linha()
                print(f'\033=1;31mVOCÊ PERDEU! :C\033[m')
                break
    ...
    if escolha == 3:
        ...
        while True:
            ...
            sleep(0.7)
            print(f'O Rayquaza agora está com \033[1;31m{vida_inimigo(vida_rayquaza, values_ven[ataque])}\033[m de vida')
            vida_rayquaza = vida_inimigo(vida_rayquaza, values_ven[ataque])
            if vida_rayquaza == 0:
                linha()
                print(f'\033[1;92mPARABÉNS! VOCÊ VENCEU\033[m')
                break
            ...
            while limites_ray[jogada_rayquaza] == 0:
                jogada_rayquaza = randint(0, 3)
            sleep(0.7)
            print(f'Agora o Venusaur está com \033[1;31m{vida_aliado(vida_venusaur, values_ray[jogada_rayquaza])}\033[m de vida')
            vida_venusaur = vida_aliado(vida_venusaur, values_ray[jogada_rayquaza])
            if vida_venusaur == 0:
                linha()
                print(f'\033=1;31mVOCÊ PERDEU! :C\033[m')
                break
